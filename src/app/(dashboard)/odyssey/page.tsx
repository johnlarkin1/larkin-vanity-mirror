...
import { useOdysseyAnalytics } from "@/hooks/use-odyssey-analytics";
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold sm:text-3xl">Odyssey</h1>
          ...
          <div className="flex flex-col items-center justify-center gap-4 py-8 text-muted-foreground">
            <div className="flex gap-6">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-sm">watchOS</span>
              </div>
            </div>
            <p className="text-sm">Download tracking will be available once Odyssey is published to the App Store</p>
          </div>
        </CardContent>
      </Card>
    </div>
